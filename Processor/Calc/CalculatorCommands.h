...
ProcessorErr_t StackOperation(Processor *processor_info, Stack_t (*operation)(Stack_t, Stack_t), FILE *file);
...
ProcessorErr_t PopR_C(Processor *processor_info, FILE *open_log_file);
