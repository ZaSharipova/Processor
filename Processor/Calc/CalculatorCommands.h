...
ProcessorErr_t StackOperation(Stack_Info *stk, Stack_t (*operation)(Stack_t, Stack_t), int *pointer, FILE *file);
...
ProcessorErr_t PopR_C(Processor *processor_info, int *pointer, FILE *open_log_file);
ProcessorErr_t Out_C(Stack_Info *stk, int *pointer, FILE *open_log_file, FILE *open_out_file);

ProcessorErr_t J_C(FILE *open_file, int *pos, Processor *processor_info);
