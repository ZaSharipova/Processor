...
asm: $(ASM_SRC)
	@$(COMP) $(CFLAGS) -D_Assembler $(ASM_SRC) $(FILEOP_SRC) $(PARSE_SRC) $(ALLLOG_SRC) $(STACK_SRC) $(PROCFUNC_SRC) $(HASH_SRC) -o asm.out
	@rm -rf *.dSYM

proc: $(PROC_SRC)
	@$(COMP) $(CFLAGS) -D_Processor $(PROC_SRC) $(FILEOP_SRC) $(PARSE_SRC) $(CALC_SRC) $(STACK_SRC) $(PROCFUNC_SRC) $(ALLLOG_SRC) $(NCURSES_SRC) -o proc.out
	@rm -rf *.dSYM
