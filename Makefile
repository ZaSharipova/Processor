...
asm: $(ASM_SRC)
	@$(COMP) $(CFLAGS) $(ASM_SRC) $(FILEOP_SRC) $(PARSE_SRC) $(ALLLOG_SRC) $(STACK_SRC) $(CALC_SRC) $(PROCFUNC_SRC) -o asm.out
	@rm -rf *.dSYM

proc: $(PROC_SRC)
	@$(COMP) $(CFLAGS) $(PROC_SRC) $(FILEOP_SRC) $(PARSE_SRC) $(CALC_SRC) $(STACK_SRC) $(PROCFUNC_SRC) $(ALLLOG_SRC) $(SUBS_ASM_SRC) -o proc.out
	@rm -rf *.dSYM
